...
const (
	CHUNK_ADB9E944_2C7F24FE_JS_LICENSE_TXT_RELATIVE_PATH = constant.RootPath + "/webjars/js/chunk-adb9e944.2c7f24fe.js.LICENSE.txt"
	// 文件内容的16进制表示
...
func AddRouterOfChunkAdb9e9442c7f24feJsLICENSETxt(router gin.IRouter) {
