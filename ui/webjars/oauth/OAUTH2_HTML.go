...
const (
	// OAUTH2_HTML_RELATIVE_PATH 是 oauth2.html 的路径。
	OAUTH2_HTML_RELATIVE_PATH = "/webjars/oauth/oauth2.html"
	// OAUTH2_HTML_HEX_CONTENT 是 oauth2.html 的内容。
...
// Oauth2Html 是 oauth2.html 资产。
var Oauth2Html = ui.Asset{
	Path:        OAUTH2_HTML_RELATIVE_PATH,
	ContentType: "text/html;charset=UTF-8",
	Content:     []byte(OAUTH2_HTML_HEX_CONTENT),
}
